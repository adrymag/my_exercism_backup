def is_armstrong_number(number):
    ...
    """
    number_backup = number # n
    decimal_length = 1 # l = length of n's decimal representation = no of digits in n = floor(lg(n)) + 1 # log(n) # log10(n)
    ...
    while number_backup >= 10:
        current_last_digit = number_backup % 10 # d = last digit in n
