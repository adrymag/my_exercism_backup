...
def update_column_minimum_values(minimum_column_values, all_minimum_column_positions, current_line, current_line_number, total_lines_number):
    for current_column_number in range(total_lines_number):
...
def saddle_points(matrix):
    ...
    for current_line_number in range(total_lines_number):
        ...
        if current_line_number > 0:
            [minimum_column_values, all_minimum_column_positions] = update_column_minimum_values(minimum_column_values, all_minimum_column_positions, current_line, current_line_number, total_lines_number) # update_column_minimum_values
