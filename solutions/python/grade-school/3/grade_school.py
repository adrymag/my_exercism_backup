...
class School:
    ...
    def roster(self):
        return reduce(lambda acc, g: acc.extend(sorted(self._students_by_grade[g])) or acc, sorted(self._students_by_grade.keys()), []) # inline_Lambda, current_operand, starting_point
