...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    """
    criticality_coefficient = temperature * neutrons_produced_per_second / threshold
    
    if criticality_coefficient < 0.9 :
        return "LOW"
    elif criticality_coefficient > 1.1 :
        return "DANGER"
    else: # 0.9 <= criticality_coefficient and criticality_coefficient <= 1.1
        return "NORMAL"    