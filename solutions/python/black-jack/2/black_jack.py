...
def value_of_card(card):
    ...
    if card in face_cards:
        return 10
    if card in ace_cards:
        return 1
    # else: # numerical_values = [ '2', '3', '4', '5', '6', '7', '8', '9', '10' ]
    return int(card)
...
def value_of_ace(card_one, card_two):
    ...
    if 'A' in [card_one, card_two]:
        return 1
    if value_of_card(card_one) + value_of_card(card_two) <= 10: # 21 - 11
        return 11
    # else:
    return 1
...
def is_blackjack(card_one, card_two):
    ...
    # max_ace_value_of_card(card_one) + max_ace_value_of_card(card_two) == 21
