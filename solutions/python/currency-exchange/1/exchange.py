...
def get_leftover_of_bills(amount, denomination):
    ...
    """
    # number_of_whole_bills = floor(amount / denomination)
    # leftover = amount − (number_of_whole_bills × denomination)
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    # exchangeable_value(127.25, 1.20, 10, 5) # budget, exchange_rate, spread, and denomination
    # Step 1 — Convert spread to decimal   
    spread_decimal = spread / 100.00 # = 10/100 = 0.10
    # Step 2 — Apply spread to exchange rate
    actual_rate = exchange_rate * ( 1 + spread_decimal ) # 1.20 × 1.10 = 1.32
    
    # Step 3 — Convert budget using actual rate
    raw_value = budget / actual_rate # 127.25 / 1.32 # ≈ 96.40
    # Step 4 — Fit into whole denominations
    whole_denominations_fit = get_number_of_bills(raw_value, denomination) # floor(raw_value / denomination) # floor( 96.40 / 5 ) = floor ( 19.28 ) = 19
    return denomination * whole_denominations_fit # 19 × 5 = 95
